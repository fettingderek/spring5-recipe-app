...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private List<Recipe> getRecipes() {
    ...
    // units of measure
    UnitOfMeasure eachUom = findUomByDescription("Each");
    UnitOfMeasure tablespoonUom = findUomByDescription("Tablespoon");
    UnitOfMeasure teaspoonUom = findUomByDescription("Teaspoon");
    UnitOfMeasure dashUom = findUomByDescription("Dash");
    UnitOfMeasure pintUom = findUomByDescription("Pint");
    UnitOfMeasure cupUom = findUomByDescription("Cup");
